...
int main(void) {
	const struct CMUnitTest tests[] = {
		cmocka_unit_test(arrange_views__one),

		cmocka_unit_test(arrange_views__n),
		cmocka_unit_test(arrange_views__s),
		cmocka_unit_test(arrange_views__e),
		cmocka_unit_test(arrange_views__w),

		cmocka_unit_test(arrange_views__even),

		cmocka_unit_test(arrange_views__diminish),

		cmocka_unit_test(arrange_views__dwindle),
	};
